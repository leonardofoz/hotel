...
require_once("DAO/HospedagemCriteriaDAO.php");

/**
 * The HospedagemCriteria class extends HospedagemDAOCriteria and is used
 ...
 * @version 1.0
 */
class HospedagemCriteria extends HospedagemCriteriaDAO
{
