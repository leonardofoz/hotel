...
require_once("DAO/HospedeCriteriaDAO.php");

/**
 * The HospedeCriteria class extends HospedeDAOCriteria and is used
 ...
 * @version 1.0
 */
class HospedeCriteria extends HospedeCriteriaDAO
{
