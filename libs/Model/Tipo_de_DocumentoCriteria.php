...
require_once("DAO/Tipo_de_DocumentoCriteriaDAO.php");

/**
 * The Tipo_de_DocumentoCriteria class extends Tipo_de_DocumentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class Tipo_de_DocumentoCriteria extends Tipo_de_DocumentoCriteriaDAO
{
