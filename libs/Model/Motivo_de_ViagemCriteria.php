...
require_once("DAO/Motivo_de_ViagemCriteriaDAO.php");

/**
 * The Motivo_de_ViagemCriteria class extends Motivo_de_ViagemDAOCriteria and is used
 ...
 * @version 1.0
 */
class Motivo_de_ViagemCriteria extends Motivo_de_ViagemCriteriaDAO
{
