...
GlobalConfig::$CONNECTION_SETTING->DBName = "db_hotel";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "261183";
...
/** the root url of the application with trailing slash, for example http://localhost/gestão hoteleira/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'hotel/';
